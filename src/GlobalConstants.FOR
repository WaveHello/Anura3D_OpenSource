    ...
    !*****************************************************************************
      ...
      implicit none
        ...
        ! Debugging quad elements variables
        real(REAL_TYPE), dimension(4) :: track_shape_func_values
        real(REAL_TYPE), dimension(4, 2) :: track_shape_deriv_func_values
        real(REAL_TYPE) :: track_det_jacobian
