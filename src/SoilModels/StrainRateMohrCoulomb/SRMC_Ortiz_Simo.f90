module mod_SRMC_Ortiz_Simo
    ...
    use mod_SRMC_funcs, only:  Get_strain_invariants, MatVec, Get_invariants, &
                              YieldFunction, Get_dD_to_dEpsP, Get_dP_to_dSigma, &
                              DotProduct_2 ! Subroutines that are required for calculations
    use mod_state_params, only: check4crossing, Get_M, Get_Dp, Update_GK
