...
contains ! Routines of this module
   ...
   !    
   !    Description: 
   !    Deallocates globally accessed allocatable arrays of this module.
   !
   ! Implemented in the frame of the MPM project.
   !
   !**********************************************************************
   ...
   !**********************************************************************
   !    Subroutine: SkipElementActivation
   !
   !    Description:
   !    Returns .true. if the element is specified as an element not to be 
   !    activated if empty          .
   !    
   ...
   !
   !    Description:
   !    Checks the newly determined discretisation of activated/
   ...
   !**********************************************************************
   !
   !    Subroutine:  Checks the newly determined discretisation of activated and
   !               deactivated elements.
   ...
   !**********************************************************************
   !
   !    Subroutine:  Recursive method for checking the number of elements
   ...
   !**********************************************************************
   !
   !    Subroutine:  Checks whether GroupID should be merged with NewGroupID.
   ...
   !**********************************************************************
   !
   !    Subroutine:  Determines the number of found groups and sorts the groups
   ...
   !**********************************************************************
   !
   !    Subroutine:  Checks which elements belong to holes inside the solid body by
   ...
   !**********************************************************************
   !
   !    Subroutine:  Assigns a material ID to all elements of the found holes.
   ...
   !**********************************************************************
   !
   !    Subroutine:  Checks which elements are activated outside the solid body by
   ...
   !**********************************************************************
   !
   !    Subroutine:  Assigns a material ID to all elements of the hole whose
   ...
   !**********************************************************************
   !
   !    Subroutine:  Checks which material ID's particles of surrounding elements
   ...
   !**********************************************************************
   !
   !    Subroutine:  Writes sizes of the largest holes to text file.
   !
   ! Implemented in the frame of the MPM project.
   !
   !**********************************************************************
   ...
   !**********************************************************************
   !
   !    Subroutine:  Reads ID's of elements who should not be considered as
