...
contains ! Routines of this module
   ...
   subroutine LagrangianPhase()
      ...
      if (NFORMULATION==1) then
         ...
         if ((CalParams%NumberOfPhases==2).or.(CalParams%NumberOfPhases==3)) then
            ...
            ! Rate of momentum for liquid phase
   ...
   !    Description: To extrapolate loads from material points to nodes using
   !                 the shape function values evaluated at the material points
   !                 local position.
   !
   !**********************************************************************
   subroutine GetNodalExtAndIntForces()
